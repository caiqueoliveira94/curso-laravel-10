...
@section('content')
    ...
    <div>
        <form action="{{ route('clientes.index') }}" method="get">
            ...
            <a type="button" href="{{ route('cliente.cadastrar') }}" class="btn btn-success float-end">Incluir Cliente</a>
        </form>
                ...
                <tbody>
                    @foreach ($findCliente as $cliente)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('cliente.atualizar', $cliente->id) }}" class="btn btn-light btn-sm">Editar</a>
